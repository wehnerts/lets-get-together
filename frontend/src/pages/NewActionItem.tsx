    ...
    return (
        <div className={"new-action-item-details"}>
            <form id="newActionItem" onSubmit={onAdd}>
                ...
                <div>Image URI: <br/><input className={"writeInput"} type={"text"} placeholder="Add a picture URI" value={imageName} onChange={event => setImageName(event.target.value)} /></div>
